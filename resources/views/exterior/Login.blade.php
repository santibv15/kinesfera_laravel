...
<body>
    ...
    <div id="login-form" class="login-page">
        <div class="form-box">
            ...
            <!--iniciar sesion-->
            <form id="login" class="input-group-login" action="../../controllers/login/ingresar.php" method="POST">
            ...
            <!--registrar-->
            <form id="register" class="input-group-register" action="../../controllers/login/registrar.php" method="post">
